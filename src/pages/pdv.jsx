...
export default function PDVPage() {
  ...
  // ✅ REGRA:
  // - Lista FECHADA => não mostra nada
  // - Lista ABERTA e busca vazia => mostra TODOS
  // - Lista ABERTA e com busca => filtra pelo nome
        ...
        <div className="lg:col-span-3 rounded-xl border border-zinc-800 bg-zinc-900/30 p-4">
          <div className="flex items-center justify-between gap-3 mb-3">
            ...
            <div className="w-full max-w-sm relative">
              <input
                className="w-full rounded-md bg-zinc-950 border border-zinc-800 px-3 py-2 text-sm pr-9"
              ...
              {busca.trim() ? (
                <button
                  type="button"
                  onClick={() => setBusca("")}
                  className="absolute right-2 top-1/2 -translate-y-1/2 text-zinc-400 hover:text-zinc-200 text-base leading-none"
          ...
          {!mostrarLista ? (
            <div className="text-sm text-zinc-400">
              Lista fechada. Clique em <b>Abrir</b> para ver os produtos.
            </div>
          ) : (
